...
> Generated 2026-09-19T17:06:35.721Z from 38 modules (v2.6.5). Total LOC 29014. Do not hand-edit.
...
|--------|-----|--------|---------|------------|-------|
| main | 3677 | daily_visits,projects,settings | ./migrations/version-compare,agents-ui,backend-logos,birthdays | - | esc:9,guard+pendingSet,window:8 |
| i18n | 2222 | - |  | agents-ui.js,birthdays.js,calendar-sync.js,demo-chooser.js | pendingSet |
| sharing-drive | 1801 | groups | drive-folders,sharing-envelope,sharing-file-reconcile,utils | main.js,sharing.js | - |
