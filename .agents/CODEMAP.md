...
> Generated 2026-07-29T23:28:37.293Z from 38 modules (v1.541). Total LOC 27354. Do not hand-edit.
...
| lists | 1128 | list_items,lists | allListItems,allLists,currentView,db,js,sharing | i18n,icons,item-utils,sharing-ui,state,utils | main.js | page-empty-state,modal,bucket-card,btn,project-card,card-header,empty-state,toast | pendingSet | 21 | 33 |
...
| sharing-supabase | 1298 | habits,joined_groups,list_items,sharing_groups,sharing_items,sharing_members,todos | crypto-sync,sharing-envelope,utils | main.js | pendingSet |
