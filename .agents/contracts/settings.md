...
## Purpose
Cross-cutting app configuration — theme, language, backend picker, sharing management, agent tokens, usage stats, data import/export, and category table management.
...
- **Panes:** `['general', 'calendar', 'sharing', 'data', 'stats', 'agents', 'account']`
...
## i18n
- **Prefix:** `menu.` + `settings.` + `agents.` — see CODEMAP core modules for current key counts
