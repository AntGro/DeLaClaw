...
4. DeLaClaw creates a `DeLaClaw/` folder (`DeLaClawDev/` on dev and preview builds) in your Google Drive containing one JSON file per table (e.g. `todos.json`, `habits.json`, `settings.json`)
