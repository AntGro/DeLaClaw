...
(function () {
  ...
  function handleClick(e) {
    ...
    switch (action) {
      ...
      case 'copy-item-link': callWindow('copyItemLink', [el.dataset.linkType, getId(el), el]); break;
      ...
      case 'toggle-revoked-members': callWindow('toggleRevokedMembers', [el.dataset.groupId]); break;
