    ...
    html += `<div class="sharing-group-card">
      <div class="sharing-group-header">
        ...
        <div class="sharing-group-actions">
          ${group.folderId ? `<a class="sharing-action-btn sharing-drive-link" href="https://drive.google.com/drive/folders/${encodeURIComponent(group.folderId)}" target="_blank" rel="noopener" title="${t('sharing.open_drive_folder')}">${lucideIcon('folder', 14)} ${t('sharing.open_drive_folder')}</a>` : ''}
